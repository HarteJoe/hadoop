...
** @Purpose: This class maps a timestamp String (the output key) of form "year / month / day" to a host String (the output value).
...
** expression finds the host String. Output (key, value) is actually of class Text, which is comparable to String but optimized for network serialization.
*/
...
public class DayMapper extends Mapper< LongWritable , Text, Text, Text > {
    ...
    public void map( LongWritable key, Text value, Context context ) throws IOException, InterruptedException {
        ...
        String dayStamp = year + " / " + month + " / " + day + " ---- ";
        ...
        context.write( new Text(dayStamp), new Text(host) );              
    }
